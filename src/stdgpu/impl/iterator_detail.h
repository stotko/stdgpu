...
template <typename Container>
struct is_proxy_reference<stdgpu::detail::back_insert_iterator_proxy<Container>>
...
template <typename Container>
struct is_proxy_reference<stdgpu::detail::front_insert_iterator_proxy<Container>>
    : public thrust::detail::true_type
{
...
template <typename Container>
struct is_proxy_reference<stdgpu::detail::insert_iterator_proxy<Container>>
    : public thrust::detail::true_type
{
