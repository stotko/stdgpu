...
if(THRUST_INCLUDE_DIR)
    ...
    string(REGEX MATCH "^[0-9]" THRUST_VERSION_MAJOR ${THRUST_VERSION_STRING})
    string(REGEX REPLACE "^${THRUST_VERSION_MAJOR}00" "" THRUST_VERSION_STRING ${THRUST_VERSION_STRING})
    string(REGEX MATCH "^[0-9]" THRUST_VERSION_MINOR ${THRUST_VERSION_STRING})
    string(REGEX REPLACE "^${THRUST_VERSION_MINOR}0" "" THRUST_VERSION_STRING ${THRUST_VERSION_STRING})
    set(THRUST_VERSION_PATCH ${THRUST_VERSION_STRING})
